            ...
            <div class="maccount">
                <ul>
                   ...
                   <!-- <li><div class="shopping">
                        <img src="../images/cart.png" width="150px">
...
<div class="container">
   ...
   <div class="products-container">
      ...
      <div class="product" data-name="p-1">
         ...
         <h3>MAMY POKO DIAPER PANT LARGE 12 S</h3>
         <div class="price">LKR 760.00</div>
      </div>

      <div class="product" data-name="p-2">
         <img src="../images/26.jpg" alt="">
         <h3>MAMY POKO DIAPER PANT MEDIUM 14 S</h3>
         <div class="price">LKR 850.00</div>
      </div>

      <div class="product" data-name="p-3">
         <img src="../images/27.jpg" alt="">
         <h3>MAMY POKO DIAPER PANT SMALL 16 S</h3>
         <div class="price">LKR 915.00</div>
      </div>

      <div class="product" data-name="p-4">
         <img src="../images/28.jpg" alt="">
         <h3>MAMY POKO DIAPER PANT NEW BORN 5 S</h3>
         <div class="price">LKR 255.00</div>
      </div>

      <div class="product" data-name="p-5">
         <img src="../images/29.jpg" alt="">
         <h3>ADFIT ADULT PANT DIAPER AF L 10S</h3>
         <div class="price">LKR 4,170.00</div>
      </div>

      <div class="product" data-name="p-6">
         <img src="../images/30.jpg" alt="">
         <h3>FARLIN HERBAL BABY WET WIPES</h3>
         <div class="price">LKR 2,264.00</div>
      </div>
...
<div class="products-preview">
	<i class="back">
	<a href="../php/motherbaby.php"><img src="../images/back.png" alt=""></a></i>
   ...
   <div class="preview" data-target="p-2">
      <i class="fas fa-times"></i>
      <img src="../images/26.jpg" alt="">
      <h3>GLUCON D NIMBU PANI 100G</h3>
      <div class="stars">
         <i class="fas fa-star"></i>
         <i class="fas fa-star"></i>
         <i class="fas fa-star"></i>
      ...
      <div class="price">LKR 213.00</div>
      <div class="buttons">
      <a href="../php/payment.php" class="buy">buy now</a>
         <a href="../php/cart.php" class="cart">add to cart</a>
      </div>
